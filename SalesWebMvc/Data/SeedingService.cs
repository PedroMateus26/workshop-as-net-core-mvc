...
namespace SalesWebMvc.Data
{
    ...
    {
        public SalesWebMvcContext _context { get; set; }
        ...
        public void Seed()
        {
            if (_context.Department.Any() || _context.SalesRecords.Any() || _context.Seller.Any())
                return; //Verifica se o banco de dados está populado
            ...
            Seller s6 = new Seller(6, "Alex Pink", "pink@gmail.com", new DateTime(1997, 3, 4), 3000.0, d1);
